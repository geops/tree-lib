CREATE TABLE projections_export (id serial, forest_ecoregion text, heightlevel heightlevel,
...
INSERT INTO projections_export (forest_ecoregion, heightlevel, foresttype, targets, additional, tannenareal, relief, slope) -- 3.) Match CSV values to enum values.
 WITH slopes AS
       (SELECT slope,
...
LEFT JOIN slopes ON slopes.slope = i.slope COPY
       (WITH relief AS
               (SELECT foresttype,
                       region,
                       heightlevel,
